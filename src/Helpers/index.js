...
export const EmployeeSelect = ({ formik }) => {
  ...
  return (
    <SearchAndSelect name="employee_id" formik={formik} options={employees} loading={isLoading} label="Assign To" />
  )
}
...
export const CampaignSelect = ({ formik }) => {
  ...
  return <SearchAndSelect name="campaign_id" formik={formik} options={compaigns} loading={isLoading} label="Campaign" />
}
