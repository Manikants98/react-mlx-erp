...
const ManageMeeting = () => {
  ...
  return (
    <>
      <GlassDiv className="overflow-y-scroll w-full !p-0">
        ...
        <form onSubmit={formik.handleSubmit} className="w-full h-auto p-2 font-poppins">
          ...
          <div className="grid items-center grid-cols-1 gap-2 lg:grid-cols-2 md:grid-cols-2">
            <CustomInput className="!w-4/5" id="title" formik={formik} label="Title" placeholder="Enter Title" />

            <CustomInput className="!w-4/5" id="date" label="Meeting Date" type="date" formik={formik} />
            <CustomInput className="!w-4/5" id="from_time" label="From Time" type="time" formik={formik} />
            <CustomInput className="!w-4/5" id="to_time" label="To Time" type="time" formik={formik} />
            <CustomInput
              className="!w-4/5"
              id="location"
              formik={formik}
          ...
          <p className="py-1 font-bold text-blue-800 ">Participents</p>
          <div className="grid items-center grid-cols-1 gap-2 lg:grid-cols-2 md:grid-cols-2">
            <CustomSelect
              className="!w-4/5"
              multiple
