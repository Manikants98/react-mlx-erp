...
import { Box, Divider, IconButton, Modal, useTheme } from "@mui/material"
      ...
      >
        <Box
          className={classNames(
            "absolute rounded-lg z-10 backdrop-blur-xl bg-white bg-opacity-20 border-opacity-30 border border-white top-1/2 left-1/2 outline-none -translate-x-1/2 overflow-y-auto -translate-y-1/2 w-1/2 shadow-md",
            className
          )}
