    ...
    <>
      ...
      <CustomModal open={isDelete} onClose={handleClose} padding={2} className="!w-[450px]">
        <div className="flex flex-col items-center gap-3 pb-5">
          ...
          <p className="text-white">You want to delete selected Items?</p>
        </div>
        <span className="flex justify-end gap-3">
          <CustomButton size="small" variant="outlined" color="secondary" onClick={handleClose} className="!capitalize">
            No
          </CustomButton>
